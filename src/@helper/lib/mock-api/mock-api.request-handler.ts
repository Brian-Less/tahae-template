...
import { HelperMockApiReplyCallback } from '@helper/lib/mock-api/mock-api.types';

export class HelperMockApiHandler {
    request!: HttpRequest<any>;
    urlParams!: { [key: string]: string };

    // Private
    private _reply: HelperMockApiReplyCallback = undefined;
     ...
     * @param callback
     */
    reply(callback: HelperMockApiReplyCallback): void {
        // Store the reply
