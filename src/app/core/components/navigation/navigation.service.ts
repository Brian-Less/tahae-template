...
export class CoreNavigationService
{
    ...
    private _navigationStore: Map<string, CoreNavigationItem[]> = new Map<string, any>();
     ...
     * @param navigation
     */
    storeNavigation(key: string, navigation: CoreNavigationItem[]): void
    {
        // Add to the store
     ...
     * @param key
     */
    getNavigation(key: string): CoreNavigationItem[]
    {
     ...
     */
    getFlatNavigation(navigation: CoreNavigationItem[], flatNavigation: CoreNavigationItem[] = []): CoreNavigationItem[]
    {
     ...
     * @param navigation
     */
    getItem(id: string, navigation: CoreNavigationItem[]): CoreNavigationItem | null
    {
        for ( const item of navigation )
        {
            if ( item.id === id )
    ...
    getItemParent(
        ...
        parent: CoreNavigationItem[] | CoreNavigationItem
    ): CoreNavigationItem[] | CoreNavigationItem | null
    {
        for ( const item of navigation )
        {
            if ( item.id === id )
